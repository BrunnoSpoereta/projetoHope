namespace AppValidationLogin
{
    public class Validation
    {
        ...
        //Definir as propriedades referente ao nosso "PAR" de componentes
        private Entry EntryCampo {  get; set; }
        private Label LabelValidation { get; set; }

        //Criar o contrutor para fazer o vinculo
        ...
        //Metodo para retornar o conteudo do Entry
        ...
        //Método que retorna se o conteudo do campo é igual a X texto
